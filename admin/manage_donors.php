...
$searchCondition = '';
if (!empty($search)) {
    $searchCondition = " WHERE d.first_name LIKE '%$search%' OR d.last_name LIKE '%$search%' OR d.email LIKE '%$search%' OR d.contact_number LIKE '%$search%'";
}
...
$query = "SELECT d.donor_id, d.first_name, d.last_name, d.gender, d.date_of_birth, 
          bg.group_name, d.contact_number, d.email, d.city, d.last_donation_date, d.is_eligible 
          FROM donors d 
          JOIN blood_groups bg ON d.blood_group_id = bg.group_id 
          $searchCondition 
          ORDER BY d.donor_id DESC 
          LIMIT $offset, $recordsPerPage";
$result = $conn->query($query);

// Get total number of donors for pagination
$countQuery = "SELECT COUNT(*) as total FROM donors d $searchCondition";
    ...
    <div class="container">
        ...
        <main class="dashboard-container">
            ...
            <div class="dashboard-content">
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($donor = $result->fetch_assoc()): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $age; ?></td>
                                    <td><?php echo $donor['group_name']; ?></td>
                                    ...
                                    <td><?php echo $donor['is_eligible'] ? 'Eligible' : 'Not Eligible'; ?></td>
                                    <td>
                                        <a href="view_donor.php?id=<?php echo $donor['donor_id']; ?>">View</a> | 
                                        <a href="edit_donor.php?id=<?php echo $donor['donor_id']; ?>">Edit</a> | 
                                        <a href="record_donation.php?donor_id=<?php echo $donor['donor_id']; ?>">Record Donation</a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php else: ?>
                ...
                <div>
                    <p>Total Donors: <?php echo $totalRecords; ?></p>
